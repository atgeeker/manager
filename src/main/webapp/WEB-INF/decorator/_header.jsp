...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    	...
    	<!-- NProgress -->
    	<link href="${contextPath}/static/css/nprogress.css" rel="stylesheet">
    	<!-- iCheck -->
    	<link href="${contextPath}/static/css/green.css" rel="stylesheet">
    	<!-- bootstrap-progressbar -->
    	<link href="${contextPath}/static/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    	<!-- Custom Theme Style -->
    	<link href="${contextPath}/static/css/custom.min.css" rel="stylesheet">
        <!--[if lt IE 9]>
